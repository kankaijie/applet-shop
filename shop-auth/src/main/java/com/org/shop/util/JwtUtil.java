...
public class JwtUtil {
     ...
     * @return
     */
    public static Claims parseJWT(String token, JwtUser jwtUser) {
        //签名秘钥，和生成的签名的秘钥一模一样
        String key = jwtUser.getPassword();
     ...
     * @return
     */
    public static Boolean isVerify(String token, JwtUser jwtUser) {
        //签名秘钥，和生成的签名的秘钥一模一样
        String key = jwtUser.getPassword();
        ...
        if (claims.get("password").equals(jwtUser.getPassword())) {
            return true;
        }
